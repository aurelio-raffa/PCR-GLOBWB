...
def modify_ini_file(original_ini_file,
    ...
    # NOTE: This function is defined here, BEFORE the top-level script body below uses
    # it. It used to be defined at the bottom of the module, after its own call site,
    # which raised a NameError as soon as this runner was executed.
    ...
    if "-tmp_annavg_ff" in system_argument:
        ...
        msg = "The file 'TMP_ANNUAL_AVG_FILE' is set based on the system argument (-tmp_annavg_ff): " + tmp_annavg_ff
        print(msg)
